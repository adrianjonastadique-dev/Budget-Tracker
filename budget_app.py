...
# 2. UNIFIED APPLE-STYLE UI OVERRIDE
st.markdown("""
    <style>
    ...
    /* FIX: Icon/Text Overlap Glitch */
    .stSelectbox label, .stNumberInput label, .stExpander label {
    ...
    /* Professional Success/Income Pill */
    div[data-testid="stNotification"] {
        background-color: #EBFBEE !important;
        color: #2F6132 !important;
...
def get_cycle_sum(cat):
    ...
    return float(val) if val > 0 else 0.0 # Standardized fallback

# Your code continues with st.session_state updates...
